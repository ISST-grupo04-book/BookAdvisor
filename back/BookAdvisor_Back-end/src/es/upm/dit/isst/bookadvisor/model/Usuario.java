...
public class Usuario implements Serializable{
	...
	public String toString() {
		return "Usuario [ID=" + ID + ", email=" + email + ", pwd=" + pwd + ", username=" + username + ", nombre="
				+ nombre + ", telefono=" + telefono + ", IDlocalizacion=" + IDlocalizacion + ", comentarios="
				+ comentarios + ", intercambios=" + intercambios + "]";
	}
