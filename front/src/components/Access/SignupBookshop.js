...
export default class Bookshop extends React.Component {
  render(){
    ...
    return (
      <div className="p-5 h-auto w-75 d-flex flex-column justify-content-start align-items-start bg-white" style={styles.bookshop__wrapper}>
        ...
        <div className="mt-3 w-100 d-flex justify-content-between align-items-center">
          ...
          <Link className="link__hover" style={styles.link} key="key2" to="/signup">Atrás</Link>
        </div>
      </div>
    );
  }
