...
public class Usuario implements Serializable{
	...
	public String toString() {
		return "{\"ID\":" + ID + ", \"email\":" + "\"" + email + "\"" + ", \"pwd\":" + "\"" + pwd + "\"" +", \"username\":" 
				+ "\""+ username + "\"" + ", \"nombre\":" + "\"" + nombre + "\"" +", \"telefono\":" + telefono + ", \"IDlocalizacion\":" 
				+ "\"" + IDlocalizacion.getID() + "\""+ ", \"comentarios\":" + "\"" + comentarios + "\"" + ", \"intercambios\":" 
				+ "\"" + intercambios + "\"" + "}";
